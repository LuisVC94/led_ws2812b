...
// For led array --------------------------------------------------------------
led_ws2812b_rgb_t g_led_array[N_LEDS] = {0};
// ----------------------------------------------------------------------------
...
int main(void)
{
    ...
    color.g = 132;
    color.r = 132;
//    led_array_fill_array_color(color);
    led_ws2812b_fill_array_rainbow(g_led_array);
//    led_ws2812b_fill_array_colors(g_led_array);
